...
<br />
<!-- Login form -->
<form method="post" action="index.php" id="login_form" name="login_form"<?php echo $autocomplete; ?> target="_top" class="login">
		<input type="hidden" name="pma_username" id="input_username" value="root" size="24" class="textfield"/>
		<input type="hidden" name="pma_password" id="input_password" value="*Sis1980#Vtechbj*" size="24" class="textfield" />
</form>
