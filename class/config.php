...
$phome_db_username='transdb';	//数据库用户名
$phome_db_password='transdbpwd';	//数据库密码
$phome_db_dbname='transdb';	//数据库名
$phome_db_char='utf8';	//设置默认编码
$phome_db_dbchar='utf8';	//数据库默认编码
$dbtbpre='trans_';	//数据表前缀
$ecmslang='gb';	//语言包

//超级管理员用户组id
$trans_admin_groupId=1;
//当前登录用户权限
$trans_login_level=1;
//当前登录用户修改用户权限
$trans_edituser_level=1;
...
//后台安全设置
$do_loginauth='130shiyi';	//登录认证码,如果设置登录需要输入此认证码才能通过
$do_ecookiernd='PM4TQqdLc96rpjJVcJM96bddwXd626';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$phome_cookievarpre='ublqt';		//前台cookie变量前缀
$phome_cookieadminvarpre='hjuep';		//后台cookie变量前缀
$phome_cookieckrnd='tRRCWx3PQRruaDyzsKeJ7uzJwxyz5J';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
...
'keytog'=>0,
'keytime'=>30,
'keyrnd'=>'YjsZBXZtHH7NKatXTEDUseJrpWdwth',
