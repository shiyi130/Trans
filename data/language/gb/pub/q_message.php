...
$qmessage_r=array(
	...
	'CloseQAdd'=>'系统关闭投稿功能',
	'HaveCloseWords'=>'您提交的信息含有非法字符('.$GLOBALS['msgclosewords'].')，提交失败.',
	...
	'PlOutTime'=>'系统限制的发表评论间隔是 '.$public_r[pltime].' 秒,请稍后再发',
	...
	'AddPlSuccess'=>'增加评论成功',
	'PlSizeTobig'=>'您的评论内容过长，系统不接受（系统限制 '.$public_r[plsize].' 字节）',
	...
	'FailKey'=>'验证码不正确',
	'OutKeytime'=>'验证码已过期',
	'EmptyMsg'=>'请输入标题、信息内容与发送目标',
	'MsgToself'=>'不能发给自己!',
	'MoreMsglen'=>'内容过长,发送不成功',
	'MsgNotToUsername'=>'接收者帐号不存在!',
	'UserMoreMsgnum'=>'对方短信息已满，发送不成功!',
	'AddMsgSuccess'=>'短信息发送成功!',
	'SelfMoreMsgnum'=>'您的短信息已满，保存不成功!',
	'AddOutmsgSuccess'=>'短信息已保存至发件箱!',
	'EmptyDelMsg'=>'请选择要删除的短信息',
	'DelMsgSuccess'=>'删除短信息成功',
	'HaveNotMsg'=>'此信息不存在',
	'HaveNotEnLevel'=>'权限不足',
	'NotUsername'=>'此帐号不存在',
