...
$message_r=array
(	
	'SearchUserSuccess'=>'成功查询到用户信息',
	'NotSearchUserid'=>'不能查询到用户，请重新输入查询条件！',
	'DelUserfail'=>'不能删除当前登录用户',
	'DelAdminfail'=>'不能删除超级管理员',
	'KEYBOARDNOTNULL'=>'请输入有效的关键字',
	'EditLoginUserfail'=>'不能修改登录用户',
	'EditAdminfail'=>'不能修改超级管理员',
	'EditUserSuccess'=>'修改用户成功',
	'EditUserInfo'=>'设定用户',
	'EmptyUserpassword'=>'请输入密码',
	'EnterUserInfo'=>'请用户信息',
	'reEnterpassword'=>'输入密码不正确，请输入10位以下的数字或英文字母',

	'NotExecuteLevel'=>'没有操作权限',
	'add_PhraseSuccess'=>'追加信息成功',
	'UpdatePhraseSuccess'=>'批量更新信息成功',
	'DeleteBakPhraseSuccess'=>'批量删除信息成功',
	'DeletePhraseSuccess'=>'指定信息删除成功',
	...
	'EmptyPayfsid'=>'请选择要删除的方式',
	'DelPayfsSuccess'=>'删除方式成功',
	'NotSetDdid'=>'请至少选择一个要设置的订单',
	'SetHavepriceSuccess'=>'设为已付费订单成功',
	'SetOutProductSuccess'=>'设为已出货订单成功',
	'SetCheckedSuccess'=>'确认订单成功',
	'SetNoCheckedSuccess'=>'取消确认订单成功',
	'DelDdSuccess'=>'删除订单成功',
	...
	'DelMoreMsgSuccess'=>'批量删除短信息成功',
	'EmptySendMsg'=>'请输入标题与内容',
	'SendMsgSuccess'=>'发送站内信息成功',
	...
	'EmptyInfoTypeName'=>'请输入分类名称',
	'AddInfoTypeSuccess'=>'增加标题分类成功',
	'EditInfoTypeSuccess'=>'设置标题分类成功',
